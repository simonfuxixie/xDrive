...
import Styles from '@Screen/Public/Attributes/Style';
            ...
            <Header style={Style.navigation}>
                ...
                <View style={Style.nav}>
                    ...
                    <View style={Style.navMiddle}>
                        <Text style={Style.navMiddleText}>{'Our Attributes'.toUpperCase()}</Text>
                    </View>
                ...
                <View style={Styles.attributes}>
                    <FlatList
                        ...
                        renderItem={({ item, separators }) => (
                            <TouchableOpacity underlayColor='transparent' onPress={() => { NavigationService.navigate('PublicAttributesDetail') }}>
                                <View style={Styles.attributesItem}>
                                    <View style={Styles.attributesItemLeft}>
                                        <Image source={item.image} style={Styles.attributesItemImg} />
                                    </View>
                                    <View style={Styles.attributesItemContent}>
                                        <Text style={Styles.attributesItemTitle}>{item.title}</Text>                                        
                                    </View>
                                </View>
                            </TouchableOpacity>
                        )}
